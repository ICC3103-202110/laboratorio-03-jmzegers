...
while i < num_jugadores:
    ...
    jugador = Jugador(nombre, i, 2, cartas_jug)
        ...
        if jugador_turno.num_monedas < 3:
            ...
            if r == "S":
                ...
                for i in jugadores:
                    ...
                    j+=1
                asesinato=int(input())
                carta_perdida=int(input("fuiste asesinado "+asesinato.nombre+" elije que carta perder 1/2"))-1
                asesinato.nombre.cartas.pop(carta_perdida)
